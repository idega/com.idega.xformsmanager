...
public class XFormsManagerMultiUploadImpl extends XFormsManagerImpl implements
	...
	final private XPathUtil uploadErrorMsgElementXpath = new XPathUtil(
	        ".//xf:output[@value]");
	final private XPathUtil uploadHeaderElementXpath = new XPathUtil(
	...
	private Element getUploadersHeaderElement(FormComponent component) {
		...
		Element headerTextElem = (Element) uploadHeaderElementXpath
	...
	protected void updateErrorMsg(FormComponent component,
		...
		Element output = (Element) uploadErrorMsgElementXpath
		        .getNode(xformsComponentDataBean.getElement());
