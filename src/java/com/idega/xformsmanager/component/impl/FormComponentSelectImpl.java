 ...
 */
public class FormComponentSelectImpl extends FormComponentImpl implements
		ComponentSelect {
	...
	protected void setProperties() {
		...
		properties.setExternalDataSrcPlain(xforms_manager
				.getExternalDataSrc(this));
