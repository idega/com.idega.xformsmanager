...
//		component.render();
	...
	protected void addComponentToChildren(FormComponent component, String nextSiblingId) {
...
//			setting the next sibling for component that goes before the new component
			getContainedComponent(childrenIds.get(childrenIds.size()-1)).setNextSibling(component);
...
//					tell the component, that will go before this new component about itself
					getContainedComponent(childrenIds.get(i-1)).setNextSibling(component);
